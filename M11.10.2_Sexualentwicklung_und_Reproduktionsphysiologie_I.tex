...
%% Hook: 
{
  \usebackgroundtemplate{\includegraphics[width=1.2\paperwidth]{bienchen_bluemchen.jpg}} 
\begin{frame}
...
\item
FSH und LH erreichen den im Ovar befindlichen Follikel
\item
...
\item 
verstärkte Umwandlung in Androgene, Androgene diffundieren in die Granulosazellen (wo Aromatase vorhanden ist und sie daher in Östrogene umgewandelt werden können)
\end {itemize}
\end{column}
...
\begin{itemize}
    ...
    \item
    Der dominante Follikel ist hochsensitiv und braucht daher nur basale FSH und LH Konzentrationen. Damit bleibt er (meistens) als einziger Follikel für die Ovulation
...
\begin{frame}{Der Follikel im Zyklus - Zusammenfassung}

\begin{center}
    \includegraphics[width=0.8\textwidth]{follikelzyklus.png}
\end{center}
...
%% Endometriose
\begin{frame}{Endometriose}

Endometrium-Gewebe kommt außerhalb der Gebärmutterhöhle vor (z.B. Gebärmutter-Muskulatur, Ovidukt, Ovar, Scheidenwand, Darm)

\begin{block}{Mögliche  Symptome}
...
\begin{itemize}
    \item 
    Schmerzen, Schwellung, Entzündung während der Menstruation
    \item
    Narbenbildung, Adhäsion von Organen, Folgewirkung von Entzündung: anhaltende Schmerzen, Zyklusstörungen, Infertilität
    \item
    Müdigkeit, Kopfschmerzen, Erbrechen, Stress
...
%% %% Die Zervix im Zyklus
 \begin{frame}{Zervix im Zyklus}
 
 \begin{itemize}
\item
Zervixdrüsen sondern Zervixschleim aus
     \item 
     Der Zervixschleim ist normalerweise sehr dickflüssig und bildet eine Barriere für Spermien (und Krankheitserreger)
     \item
 Hohe  Östrogen-Konzentration bei der Ovulation macht den  dünnflüssig und daher durchlässig
 \item
 Danach verdickt sich der Zervixschleim wieder
 
 \end{itemize}
 
 \end{frame}

\begin{frame}{Zyklus: Wie passt alles zusammen?}
...
{
  \usebackgroundtemplate{\includegraphics[width=1.2\paperwidth]{pill.jpg}} 
\begin{frame}
...
Pearl-Index (tatsächlich):  \pause 1-8 \\
...
\item
Follikel im Zyklus.CC BY-SA 3.0, \url{https://commons.wikimedia.org/w/index.php?curid=801807}

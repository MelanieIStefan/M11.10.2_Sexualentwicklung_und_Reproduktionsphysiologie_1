...
% (sex-determining region Y) = SRY-Gen \(\Rightarrow\) männliche Ausprägung: Hodenentwicklung (Testisentwicklung)
%    - Produktion Anti-Müller Hormon (AMH) \(\rightarrow\) Degeneration Müllerscher Gang
%    - Produktion männlicher Geschlechtsorgane (Penis, Hodensack, Nebenhoden, Bläschendrüse, Samenleiter)
%   - Standard: weibliches Geschlecht (unabhängig von weiblichen Geschlechtshormonen)
